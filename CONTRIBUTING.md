...
of Shush, then here are some notes on how to do that.
...
If you're looking for something to work on, have a look at the open issues in the repository [here](https://github.com/samagra14/Shush/issues).
